...
- OpenAPI client: `src/permissions-app/ui/lib/api/` (auto-generated)
- Routes: `src/permissions-app/ui/routes/`
- Components: `src/permissions-app/ui/components/`
- Backend: `src/permissions-app/backend/`
