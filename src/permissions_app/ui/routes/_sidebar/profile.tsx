...
import { useCurrentUserSuspense, type ComplexValue } from "@/lib/api";
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="border-primary/20">
          ...
          <CardContent className="space-y-4">
            {user.emails && user.emails.length > 0 ? (
              user.emails.map((email: ComplexValue, index: number) => (
                <div key={index}>
          ...
          <Card className="border-primary/20">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {user.roles.map((role: ComplexValue, index: number) => (
        ...
        {user.groups && user.groups.length > 0 && (
          <Card className="border-primary/20">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {user.groups.map((group: ComplexValue, index: number) => (
                  <Badge key={index} variant="outline">
        ...
        {user.entitlements && user.entitlements.length > 0 && (
          <Card className="border-primary/20">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-2">
                {user.entitlements.map((entitlement: ComplexValue, index: number) => (
